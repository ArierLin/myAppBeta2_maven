 ...
 * 2017-11-03T15:18:01.202+08:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "WeatherWebService", 
                  wsdlLocation = "file:/E:/idea_practiceSpace/myAppBeta2_maven/myAppBeta2_webService/src/main/java/com/jr/weather/weather_wsdl.wsdl",
...
public class WeatherWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/idea_practiceSpace/myAppBeta2_maven/myAppBeta2_webService/src/main/java/com/jr/weather/weather_wsdl.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/idea_practiceSpace/myAppBeta2_maven/myAppBeta2_webService/src/main/java/com/jr/weather/weather_wsdl.wsdl");
        }
        WSDL_LOCATION = url;
    }
